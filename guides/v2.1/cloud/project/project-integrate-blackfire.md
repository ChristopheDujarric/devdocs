...
{% include cloud/note-blackfire-legacy.md %}
...
We recommend working in a branch and creating a snapshot prior to installing. If you have a branch already created, you can skip down to the steps for setting up Blackfire. If you need instructions creating a branch, complete the following:
...
#### Next, setup Blackfire:

1.  Execute the Blackfire setup command

   ```bash
   magento-cloud blackfire:setup
   ```

   Environments will re-deploy to take changes into account.
